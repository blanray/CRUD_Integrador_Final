...
public class ProductosDAO {
    ...
    private static final String SQL_READ_BY_ID = "SELECT a.*, b.tip_descripcion FROM productos a, tipos_producto b WHERE a.prd_id = ? and a.prd_tip_id = b.tip_id";
    ...
    public Productos seleccionarPorId(int id) {
        Connection conn = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
