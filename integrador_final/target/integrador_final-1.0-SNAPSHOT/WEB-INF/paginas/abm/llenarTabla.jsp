                            ...
                            <tbody>
                                <p:forEach var="producto" items="${productos}" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/servletControlador?accion=editarProducto&temporal=${producto.prd_id}" class="btn btn-warning">
                                                Editar
                                            </a>
                                        </td>
                                        <td>
                                            <a href="${pageContext.request.contextPath}/servletControlador?accion=eliminarProducto&temporal=${producto.prd_id}" class="btn btn-danger">
                                                Eliminar
                                            </a>
                                        </td>
                                    </tr>
